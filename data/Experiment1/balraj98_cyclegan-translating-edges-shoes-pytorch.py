...
# ## Introduction
# ### In this notebook we use [CycleGAN](https://arxiv.org/abs/1703.10593) to translate Shoe-Edges to Shoes using [Edges2shoes Dataset](https://www.kaggle.com/balraj98/edges2shoes-dataset).

# <img src="https://user-images.githubusercontent.com/7057863/49054732-354dad80-f1c3-11e8-8406-5b3570a8cc47.png" width="800" height="800"/>
# <h4></h4>
# <h4><center>Image Source:  <a href="https://people.eecs.berkeley.edu/~tinghuiz/projects/pix2pix/datasets/">Edges2shoes Dataset</a></center></h4>
